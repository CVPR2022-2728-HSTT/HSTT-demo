...
class AGQADataset(Dataset):
    ...
    def __init__(self, datalist, tokenizer, vid_lmdb_dir,
        ...
        self.graph_search_order_dict = torch.load(f'{vid_lmdb_dir}/graph_search_order_dict.pytorch')
    ...
    def _load_video(self, video_id):
        ...
        return embedding_dict, self.graph_search_order_dict[video_id]
    ...
    def __getitem__(self, index):
        ...
        for _ in range(num_retries):
            ...
            embedding_dict, search_order = self._load_video(vid_id)  # dump dictionary
    ...
    def evaluate_all_metric(self, results):
        """
        Args:
            results: list(dict),
              each dict is
...
class VideoQACollator(object):
    ...
    def collate_batch(self, batch):
        ...
        order_info = [d["order_info"] for d in batch]  # <list> (B, list)
        # group data
